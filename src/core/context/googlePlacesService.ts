...
const GOOGLE_PLACES_API_KEY = process.env.EXPO_PUBLIC_GOOGLE_PLACES_API_KEY; // Replace with your API key
...
export const getPlaceAutocomplete = async (
	...
	try {
		...
		const response = await axios.get(`${GOOGLE_PLACES_API_URL}/autocomplete/json`, { params });
...
export const getPlaceDetails = async (
	...
	try {
		...
		const response = await axios.get(`${GOOGLE_PLACES_API_URL}/details/json`, { params });
